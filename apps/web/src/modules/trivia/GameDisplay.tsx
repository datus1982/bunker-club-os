 ...
 * short/medium questions. The fit itself lives in `shared/useFitSize.ts` (shared with the
 * picture-round answer key AND, since 2026-09-17, the host SCORING console's question pane).
 */
function FitBox({
  text,
  maxSize,
