...
--
-- ── OWNER TODO — every value below is PLACEHOLDER copy to replace before launch:
--     site_hero_title, site_hero_sub  → real tagline
--     site_hours                       → REAL open/close times (invented bar hours)
--     site_address                     → verify suite/zip (433 NW 23rd St from Toast)
--     site_parking                     → real parking guidance
--     site_socials                     → real Instagram/Facebook URLs (now '#')
...
insert into public.venue_settings (venue_id, key, value) values
  ...
  -- PLACEHOLDER hours (Tue–Sun 4pm–2am, closed Monday) — owner to confirm.
